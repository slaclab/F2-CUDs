...
SBST_BOLD = QFont('Sans Serif', 26)
SBST_REG = QFont('Sans Serif', 18)

STAT_BOLD = QFont('Sans Serif', 22, QFont.Bold)
STAT_REG  = QFont('Sans Serif', 22)
...
class klysIndicator(QFrame):
    ...
    def __init__(self,
        ...
        L.addWidget(stat)
        L.setSpacing(2)
        L.setContentsMargins(10,0,10,10)
        self.setLayout(L)
